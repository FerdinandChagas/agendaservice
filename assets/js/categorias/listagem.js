        ...
        .then(data => {
            ...
            if (dadosTbody) {
                ...
                data.forEach(categoria => {
                    ...
                    newRow.innerHTML = `<td class="text-primary">${categoria.nome}</td>
                                       <td class="text-primary">${categoria.max_passageiros}</td>
                                       <td class="text-primary">${categoria.combustivel}</td></tr>`;
                });
            } else {
